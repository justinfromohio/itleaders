...
class FW_Option_Type_NewIcon extends FW_Option_Type {
    ...
    private function generate_unknown_set($icon) {
        return array(
            ...
            'container-class' => '',
            'groups' => array(
                'unknown' => esc_html__('Unknown Set', 'archer'),
            ),
            'icons' => array(
    ...
    private function get_default_sets() {
		...
		//     groups => array(
        //         array(
        //             'title' => esc_html__('Web Application Icons', 'archer')
        //             'icons' => array('fa fa-adjust', 'fa fa-anchor', ...),
        //         ),
        //         array(
        //             'title' => esc_html__('Transportation Icons', 'archer'),
        //             'icons' => array(...),
        //         ),
        //     )
        //
        ...
        return array(
            'font-awesome' => array(// http://fortawesome.github.io/Font-Awesome/icons
                ...
                'groups' => array(
                    'web-application' => esc_html__('Web Application Icons', 'archer'),
                    'hand' => esc_html__('Hand Icons', 'archer'),
                    'transportation' => esc_html__('Transportation Icons', 'archer'),
                    'gender' => esc_html__('Gender Icons', 'archer'),
                    'file-type' => esc_html__('File Type Icons', 'archer'),
                    //'spinner'         => 'Spinner Icons',
                    //'form-control'    => 'Form Control Icons',
                    'payment' => esc_html__('Payment Icons', 'archer'),
                    //'chart'           => 'Chart Icons',
                    'currency' => esc_html__('Currency Icons', 'archer'),
                    'text-editor' => esc_html__('Text Editor Icons', 'archer'),
                    'directional' => esc_html__('Directional Icons', 'archer'),
                    'video-player' => esc_html__('Video Player Icons', 'archer'),
                    'brand' => esc_html__('Brand Icons', 'archer'),
                    'medical' => esc_html__('Medical Icons', 'archer'),
                    'line-icon' => esc_html__('Custom Liner Icons', 'archer'),
                ),
                'icons' => array(
