...
<div <?php echo fw_attr_to_html( $wrapper_attr ) ?>>
	...
	<div class="fw-table">
		<br class="fw-cell-template"
			...
			echo fw_htmlspecialchars( fw_render_view( $worksheet_cell_template, array(
				'option' => $option,
				'data' => $data,
			...
			echo fw_htmlspecialchars( fw_render_view( $header_cell_template, array(
				'option' => $option,
				'j' => '_template_key_col_',
				'data' => array()
			) ) )
			...
			<div class="fw-table-row <?php echo   $current_row_name ?>"
				...
				<?php foreach ( $row as $key_col => $cell_value ): ?>
					<div
						...
						<?php $worksheet_cell_template = fw_ext( 'shortcodes' )->get_shortcode( 'table' )->get_declared_path() . '/includes/fw-option-type-table/views/cell-worksheet-template.php'; ?>
						<?php echo fw_render_view( $worksheet_cell_template, compact( 'option', 'data', 'j', 'i', 'cell_value', 'current_row_name', 'desc_col' ) );
						?>
		...
		<div class="fw-table-row fw-table-cols-delete">
			...
			<div class="fw-table-cell fw-table-cell-options">
				<a href="#" class="fw-table-add-row button button-large"><?php echo __( 'Add Row', 'archer' ) ?></a>
			</div>
