...
if ($bg_options == 'image') {
    $bg_image = 'background:url(' . esc_url($atts['background_options']['image']['background_image']['data']['icon']) . ') no-repeat center center scroll;-moz-background-size: cover;background-size: cover;-webkit-background-size: cover;-o-background-size: cover;width: 100%;overflow: hidden;';
    $section_extra_classes = 'parallax-section';
    
    $bgoverlay = $atts['background_options']['image']['tab_item']['overlay11']['background'];
    $overlay11 = "style='background-color:$bgoverlay'";

    $gradient11 = 'class = "gradient-overlay"';
